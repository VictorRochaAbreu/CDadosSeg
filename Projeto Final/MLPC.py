...
def cross_v_train(x, y):
	...
	for i in range(0, 5):
		...
		skplt.metrics.plot_roc_curve(y_probs, y_train)
		plt.savefig(i + "-ROC.png")
...
if __name__ == "__main__":
	...
	skplt.metrics.plot_roc_curve(y_probs,  y_train[size_train:])
...
#-----------------essa parte é os 20% separados para teste#----------------------------
	...
	skplt.metrics.plot_roc_curve(y_probs,  y_test)
